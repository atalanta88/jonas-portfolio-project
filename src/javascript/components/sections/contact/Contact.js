export default function ContactSection() {
  return (
    <>
      {" "}
      <section className="w-full max-w-2xl px-6 py-10 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        ...
        <div className="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
          <a className="flex flex-col items-center px-4 py-3 text-gray-700 rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500">
            <svg
              className="w-5 h-5"
